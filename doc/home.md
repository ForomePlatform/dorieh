...
data pipelines are developed against restricted data, but the repository
includes synthetic Medicare data, so the Medicare pipeline can be run
and tested end to end; see the
